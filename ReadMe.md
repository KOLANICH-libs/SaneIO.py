...
=========
~~[wheel (GitLab)](https://gitlab.com/KOLANICH-libs/SaneIO.py/-/jobs/artifacts/master/raw/dist/SaneIO-0.CI-py3-none-any.whl?job=build)~~
[wheel (GHA via `nightly.link`)](https://nightly.link/KOLANICH-libs/SaneIO.py/workflows/CI/master/SaneIO-0.CI-py3-none-any.whl)
~~![GitLab Build Status](https://gitlab.com/KOLANICH-libs/SaneIO.py/badges/master/pipeline.svg)~~
~~![GitLab Coverage](https://gitlab.com/KOLANICH-libs/SaneIO.py/badges/master/coverage.svg)~~
